...
interface ComponentData {
  section_brand:
  {
    section_brand: BrandItem[];
  }[];
}

interface BrandHomemangeProps {
  component: ComponentData[];
  getComponents: () => Promise<void>;
}

const BrandHomemange = ({ component, getComponents }: BrandHomemangeProps) => {
  ...
  return (
    <section className="bg-white p-4 rounded shadow mt-3">
      ...
      <div className="flex gap-4 overflow-x-auto">
        {component[0]?.section_brand[0]?.section_brand?.map(
